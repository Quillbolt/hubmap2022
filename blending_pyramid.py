...
def colorBlending(img1, img2, mask):
  ...
  imageio.imsave("output1.png", output)
  img = cv2.imread("output1.png")
#   cv2.imshow('blend',img)
  return img


apple = imageio.v2.imread('apple.jpg')
apple = np.resize(apple, (512, 512, 3))
orange = imageio.v2.imread('orange.jpg')
# apple = np.uint8(apple)
# orange = np.uint8(orange)
